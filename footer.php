                ...
                <div class="footer-btm pt-4">
                    <div class="row">
                        <div class="col-lg-4 col-md-12 col-sm-12">
                            <div class="copyright">
                                &copy; Copyright <?= date('Y'); ?> Reserved to <span class="text-color"></span> by Patel Brothers</a>
                            </div>
                        </div>
    ...
    <!-- Bootstrap 4.3.1 -->
    <script src="web/plugins/bootstrap/js/popper.js"></script>
    <script src="web/plugins/bootstrap/js/bootstrap.min.js"></script>
   <!--  Magnific Popup-->
    <script src="web/plugins/magnific-popup/dist/jquery.magnific-popup.min.js"></script>
    <!-- Slick Slider -->
    <script src="web/plugins/slick-carousel/slick/slick.min.js"></script>
    <!-- Counterup -->
    <script src="web/plugins/counterup/jquery.waypoints.min.js"></script>
    <script src="web/plugins/counterup/jquery.counterup.min.js"></script>

    <!-- Google Map -->
    <script src="web/plugins/google-map/map.js"></script>
